...
void fsmc_init(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4 | GPIO_Pin_5 | GPIO_Pin_14 | GPIO_Pin_15 |
                                    ...
                                    GPIO_Pin_10| GPIO_Pin_12 | GPIO_Pin_7;      //选中相应的引脚
    ...
    //写配置
    writeTiming.FSMC_AddressSetupTime =9;	                //地址建立时间为9个HCLK =54ns 
    writeTiming.FSMC_AddressHoldTime = 0;	                        //地址保持时间
    writeTiming.FSMC_DataSetupTime = 9;		                //数据保持时间为6ns*9个HCLK=54ns
