...
{    
  ...
  //先初始化ADC3通道 IO口
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4;//PF3通道14
  ...
  ADC_CommonInitStructure.ADC_Prescaler = ADC_Prescaler_Div2;//预分频4分频。ADCCLK=PCLK2/2=(57.6/2)/2=14.4Mhz,ADC时钟最好不要超过36Mhz 
...
u16 Get_Adc3(u8 ch)   
{
	...
	ADC_RegularChannelConfig(ADC3, ch, 1, ADC_SampleTime_112Cycles  );	//ADC3,ADC通道,480个周期,提高采样时间可以提高精确度			    
