...
const char Temp_TitleText[][32] = {
  "Infrared temperature",
  "红外体温曲线",
};

const char Temp_Text1[][32] = {
  "Current value:",
  "当前测量值：",
};

static GRAPH_DATA_Handle hData;
static short DataBuffer[TEMP_BUFFER_SIZE] = {0};
// USER END
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    TEXT_SetText(hItem, Temp_TitleText[System.language]);
    //
    ...
    hData = GRAPH_DATA_YT_Create(GUI_RED, TEMP_BUFFER_SIZE, DataBuffer, 0);
    ...
    TEXT_SetFont(hItem, FontList16[System.font]);
    sprintf(buf,"%s 000",Temp_Text1[System.language]);
  ...
  case WM_TIMER:
    ...
    x_value = (short)(temp*2);
    GRAPH_DATA_YT_AddValue(hData,x_value);
    
    hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_1);
    sprintf(buf,"%s %.2f°C",Temp_Text1[System.language],temp);
    TEXT_SetText(hItem, buf);
...
WM_HWIN CreateTemp(void) {
  ...
  WM_CreateTimer(WM_GetClientWindow(hWin), 0x05, 50, 0); //创建一个软件定时器
  return hWin;
}
