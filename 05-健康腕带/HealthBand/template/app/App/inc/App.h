...
#define   BSP_GTP             (uint32_t)0x0001       // ´¥ÃþÆÁ´íÎó   
#define   BSP_SD              (uint32_t)0x0002       // SD¿¨´íÎó
#define   BSP_SPI_FLASH       (uint32_t)0x0004       // FLASHÇý¶¯´íÎó
#define   BSP_FILE_SYSTEM     (uint32_t)0x0008       // FLASHÇý¶¯´íÎó
#define   BSP_GUI             (uint32_t)0x0010       // emwinÔËÐÐ´íÎó 
#define   BSP_WM8978          (uint32_t)0x0020       //  The WM8978 drive cannot work           
#define   BSP_ALLOC           (uint32_t)0x0040       //  ´æ´¢Æ÷ alloc ´íÎó
#define   BSP_RTC             (uint32_t)0x0080       //  RTC¹¤×÷´íÎó
#define   BSP_RF1             (uint32_t)0x0100       // ÎÞÏßÉè±¸1´íÎó
#define   BSP_RF2             (uint32_t)0x0200       // ÎÞÏßÉè±¸2´íÎó
