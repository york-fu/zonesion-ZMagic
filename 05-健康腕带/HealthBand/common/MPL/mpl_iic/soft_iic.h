...
/**********************************************************************************************/
//I2C1
#define I2C1_SCL_RCC     RCC_AHB1Periph_GPIOA
#define I2C1_SCL_GPIO    GPIOA
#define I2C1_SCL_PIN     GPIO_Pin_6

#define I2C1_SDA_RCC     RCC_AHB1Periph_GPIOA
#define I2C1_SDA_GPIO    GPIOA
#define I2C1_SDA_PIN     GPIO_Pin_5

#define I2C1_SDA_PIN_NUM 5
...
/**********************************************************************************************/
//I2C2
#define I2C2_SCL_RCC     RCC_AHB1Periph_GPIOB
#define I2C2_SCL_GPIO    GPIOB
#define I2C2_SCL_PIN     GPIO_Pin_8

#define I2C2_SDA_RCC     RCC_AHB1Periph_GPIOB
#define I2C2_SDA_GPIO    GPIOB
#define I2C2_SDA_PIN     GPIO_Pin_9

#define I2C2_SDA_PIN_NUM 9

#define SDA2_IN          do{I2C2_SDA_GPIO->MODER &= ~(3<<(I2C2_SDA_PIN_NUM*2)); I2C2_SDA_GPIO->MODER |= (0<<(I2C2_SDA_PIN_NUM*2));}while(0)
#define SDA2_OUT         do{I2C2_SDA_GPIO->MODER &= ~(3<<(I2C2_SDA_PIN_NUM*2)); I2C2_SDA_GPIO->MODER |= (1<<(I2C2_SDA_PIN_NUM*2));}while(0)

#define SCL2_L           (I2C2_SCL_GPIO->BSRRH=I2C2_SCL_PIN)
#define SCL2_H           (I2C2_SCL_GPIO->BSRRL=I2C2_SCL_PIN)

#define SDA2_L           (I2C2_SDA_GPIO->BSRRH=I2C2_SDA_PIN)
#define SDA2_H           (I2C2_SDA_GPIO->BSRRL=I2C2_SDA_PIN)

#define SDA2_R           (I2C2_SDA_GPIO->IDR&I2C2_SDA_PIN)
