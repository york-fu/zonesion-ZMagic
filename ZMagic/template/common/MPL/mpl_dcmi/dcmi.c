#include "mpl_dcmi/dcmi.h" 

//DCMI 驱动代码	
void (*DcmiLineIrq)(void) = NULL;
...
void DCMI_IRQHandler(void)
{
	...
	{
		DCMI_ClearITPendingBit(DCMI_IT_LINE);//清除
    if(DcmiLineIrq!=NULL)
      DcmiLineIrq();
  }
...
void OV2640_DCMI_Init(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4 | GPIO_Pin_5|GPIO_Pin_6;//PE4/5/6  复用功能输出 
